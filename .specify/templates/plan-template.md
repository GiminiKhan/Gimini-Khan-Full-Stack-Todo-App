...
- [ ] All features and changes must be specified before implementation begins
- [ ] Clear requirements and acceptance criteria must be documented in spec.md

### No Manual Code
- [ ] All code must be generated through Claude Code or integrated agents
- [ ] No manual code writing is permitted
- [ ] Implementation must follow automated generation processes

### Agentic Stack
- [ ] Technology stack utilizes UV, Python 3.13+, and Claude Code as required components
